...
class UnsupervisedCTRLSG(pl.LightningModule):
    def __init__(self,
                 ...
                 Q: typing.Callable[[torch.Tensor], torch.Tensor],
        ...
        self.Q: typing.Callable[[torch.Tensor], torch.Tensor] = Q
    ...
    def u_enc(self, Z, Z_hat):
        return self.Q(Z) - self.C(Z, Z_hat)
...
class CTRLSSP(UnsupervisedCTRLSG):
    def __init__(self, d_x: int, d_z: int, eps_sq: float = 1.0,
        ...
        self.training_R = self.training_Q
